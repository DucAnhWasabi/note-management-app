        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <form method="post" action="update_note_process.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="noteTitle" name="note_title" value="<?php echo htmlspecialchars($note['note_title']); ?>">
                            </div>
                            <div class="form-group">
                                <label for="note">Note</label>
                                <textarea class="form-control" id="note" name="note_content" rows="23"><?php echo htmlspecialchars($note['note']); ?></textarea>
                            </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        Notes Details
                        <a href="http://localhost/take-note-app/all_notes.php" class="float-right">View All Notes</a>
                    </div>
